...
1. [**Retrieve entitlements**](./retrieve-entitlements/) – Retrieves the entitlements of customers who have subscribed to a product, and filters them by customer identifier and dimension.

## Prerequisites

1. An AWS account with an AWS Marketplace product and access to the Marketplace Entitlement Service.
